...
LOG_DIR="${DOWNLOADS_DIR}/S24U_H1_R5_LOGS"
...
start_private_adb_server() {
  ...
  ((rc == 0)) || fail "ADB_SERVER_START_FAILED"
...
try_existing_authorization() {
  ...
  printf '\nR5 不联网安装任何包。请输入无线调试主页面显示的完整“IP 地址和端口”，例如 172.19.0.1:35653：\n> ' >&2
